...
% tdinpixnew= tdinpix+39;
% tdinpixnew = tdinpixnew-min(tdinpixnew);
% figure;
% plot(tdinpixnew)
%part 1b)
...
% for i = 1:1:length(xi)
%     for j = 1:1:128
%          data465(i,j) = data3(i,j,65)+tdinpix(j);
%     end
% end
% data465(2354:2392,j) = 0;
% %part 1c)
% for i = 1:1:length(xi)
%     for j = 1:1:128
%         data4(i,j,:) = data3(i,j,:)+tdinpix(j);
%         disp(i)
%     end
% end
%     
...
% for i = 1:num_elements
%     for j = 1:num_elements
%         interpdata(:,i,j) = interp1((1:1:length(depth))',data_pt(:,i,j),(1:1:length(depth))'+round(tdinpix(i))');
%     end
% end
% figure;
% 
...
for j = 1:128
    ...
    ImageData4(:,j,pl*i-7) = ChDataDelay1;

    ChDataDelay2 = interp1(T(:,j), SingleChannelData, delay2(:,j));
    ImageData4(:,j,pl*i-8) = ChDataDelay2;
    
     ChDataDelay3 = interp1(T(:,j), SingleChannelData, delay3(:,j));
    ImageData4(:,j,pl*i-6) = ChDataDelay3;
    
     ChDataDelay4 = interp1(T(:,j), SingleChannelData, delay4(:,j));
    ImageData4(:,j,pl*i-9) = ChDataDelay4;
    
    ChDataDelay5 = interp1(T(:,j), SingleChannelData, delay5(:,j));
    ImageData4(:,j,pl*i-5) = ChDataDelay5;

    ChDataDelay6 = interp1(T(:,j), SingleChannelData, delay6(:,j));
    ImageData4(:,j,pl*i-10) = ChDataDelay6;
    
     ChDataDelay7 = interp1(T(:,j), SingleChannelData, delay7(:,j));
    ImageData4(:,j,pl*i-4) = ChDataDelay7;
    
     ChDataDelay8 = interp1(T(:,j), SingleChannelData, delay8(:,j));
    ImageData4(:,j,pl*i-11) = ChDataDelay8;
    
    ChDataDelay9 = interp1(T(:,j), SingleChannelData, delay9(:,j));
    ImageData4(:,j,pl*i-3) = ChDataDelay9;

    ChDataDelay10 = interp1(T(:,j), SingleChannelData, delay10(:,j));
    ImageData4(:,j,pl*i-12) = ChDataDelay10;
    
     ChDataDelay11 = interp1(T(:,j), SingleChannelData, delay11(:,j));
    ImageData4(:,j,pl*i-2) = ChDataDelay11;
    
     ChDataDelay12 = interp1(T(:,j), SingleChannelData, delay12(:,j));
    ImageData4(:,j,pl*i-13) = ChDataDelay12;
    
    ChDataDelay13 = interp1(T(:,j), SingleChannelData, delay13(:,j));
    ImageData4(:,j,pl*i-1) = ChDataDelay13;

    ChDataDelay14 = interp1(T(:,j), SingleChannelData, delay14(:,j));
    ImageData4(:,j,pl*i-14) = ChDataDelay14;
    
     ChDataDelay15 = interp1(T(:,j), SingleChannelData, delay15(:,j));
    ImageData4(:,j,pl*i-0) = ChDataDelay15;
    
     ChDataDelay16 = interp1(T(:,j), SingleChannelData, delay16(:,j));
    ImageData4(:,j,pl*i-15) = ChDataDelay16;
    
end
end
 %subplot(144)
 figure;
    sumNewImage = sum(ImageData4,2);
    ...
    ylabel('depth')
    title('part 5: N =16, point target')